...
export default function AngeloSection() {
  return (
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-shrink-0 flex flex-col items-center">
            ...
            <div className="flex items-center gap-1.5 mt-2">
              ...
              <span className="text-xs text-slate-400">Angelo Comink</span>
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 text-sm mt-2 mb-6">
              Discutez avec Angelo Comink, notre assistant IA disponible 24/7, ou parlez directement à un humain.
            </p>
            <div className="flex flex-wrap gap-3">
              <button
                onClick={() => {
                  const btn = document.querySelector<HTMLButtonElement>('[data-angelo-trigger]')
                  if (btn) btn.click()
                }}
          ...
          <div className="hidden lg:block w-72 bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden shadow-2xl">
            <div className="flex items-center gap-2 px-4 py-3 bg-slate-700 border-b border-slate-600">
              <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
              <span className="text-white text-xs font-bold">Angelo Comink</span>
            ...
            <div className="p-4 space-y-3">
              <div className="bg-slate-700 rounded-xl rounded-tl-none px-3 py-2 text-xs text-slate-200 max-w-[90%]">
                Salut ! Je suis Angelo Comink. Comment puis-je vous aider pour votre projet d'impression ?
              </div>
